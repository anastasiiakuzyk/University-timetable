...
public class EditController {
    ...
    private void addTeacher(TeacherRow teacher) {
    ...
    private void deleteTeacher(TeacherRow teacher){
        SqlClient.CreateCommand(String.format("DELETE FROM %s WHERE fullName ='%s' AND position = '%s'",SqlClient.Tables.TEACHER,teacher.get_fullName(), teacher.get_position() )).ExecNonQuarry();
    }
}
